...
export const useCases: UseCase[] = [
  ...
  },
  {
    id: "UC09",
    slug: "uc9",
    title: "EV Charging & Gas Stations",
    category: "energy",
    image: "/img/tile-09.jpg",
    emoji: "⚡",
    tags: ["EV Charging", "Gas Stations", "Open Charge Map", "NREL", "CCS", "CHAdeMO", "Tesla", "Energy Transition"],
    description: "Global EV charging stations vs gas stations on a live WebGL globe — connector types (CCS, CHAdeMO, Type 2, Tesla), charging speed, operator, and the energy transition index by region.",
    longDescription:
      "Track the global energy transition at infrastructure level. Open Charge Map and NREL data for EV charging stations worldwide — color-coded by connector type and charging speed — alongside gas/petrol stations from major oil companies. Filter by station type, click for operator, address, and max kW. The Energy Transition Index shows EV vs fossil fuel station ratio by region in real time.",
    highlights: [
      "EV charging stations from Open Charge Map (global) + NREL (US/Canada)",
      "Connector type filter: CCS / CHAdeMO / Type 2 / Tesla Supercharger",
      "Charging speed: Level 1 (3 kW) → Level 2 (22 kW) → DC Fast (350 kW)",
      "Gas stations from Shell, BP, ExxonMobil, Total, Petrobras and more",
      "Energy Transition Index — live EV vs gas station ratio per region",
      "Click any station for operator, address, connector count, and power level",
    ],
    status: "coming-soon",
    featured: false,
    demoUrl: "/uc9",
